...
First we need a text editor (vi is preinstalled but annoying to use more than once), use the instructions from step 2 to install nano or vim or emacs or whatever  
